...
try:
    ...
    db.execute("INSERT INTO STUDENT_DETAILS (STUDENT_ID, YEAR_GROUP, DATE_OF_BIRTH, EMERGENCY_PHONE, EMERGENCY_EMAIL) VALUES (1, '13', '28/12/2006', '07860204466', 'ste.thom06@gmail.com')")
    db.execute("INSERT INTO TEACHERS (TEACHERS_ID, TEACHERS_NAME) VALUES (100, 'Joel Robinson')")
    db.execute("INSERT INTO COURSES (COURSE_ID, COURSE_NAME, TEACHERS_ID, STUDENT_ID) VALUES (1000, 'GAMES', 100, 1)")
    ...
    # db.execute("INSERT INTO STUDENTS (STUDENT_ID, STUDENT_FIRST_NAME, STUDENT_LAST_NAME) VALUES ('STEPHEN', 12 , 13)")
    # db.execute("INSERT INTO STUDENT_DETAILS (STUDENT_ID, YEAR_GROUP, DATE_OF_BIRTH, EMERGENCY_PHONE, EMERGENCY_EMAIL) VALUES ('1', 13, 2006, 999, 90012)")
    # db.execute("INSERT INTO TEACHERS (TEACHERS_ID, TEACHERS_NAME) VALUES ('100', 27)")
    # db.execute("INSERT INTO COURSES (COURSE_ID, COURSE_NAME, TEACHERS_ID, STUDENT_ID) VALUES ('1000', 4000, '100', '1')")
    # db.execute("INSERT INTO STUDENT_COURSE_JOIN (STUDENT_ID, COURSE_ID) VALUES ('1', '1000')")
    # db.execute("INSERT INTO GRADES (STUDENT_ID, COURSE_ID, ASSIGNMENT_NAME, GRADE, DATE_GRADED) VALUES ('1', '1000', 6000, 7000000000, 9000)")
    # db.execute("INSERT INTO ATTENDANCE (STUDENT_ID, COURSE_ID, DAY_ATTENDANCE, TOTAL_ATTENDANCE) VALUES ('1', '1000', '1', '3')")
